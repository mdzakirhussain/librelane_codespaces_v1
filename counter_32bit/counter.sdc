# =============================================================================
#  counter.sdc - timing constraints for the 32-bit up/down counter
...
# -----------------------------------------------------------------------------
set_input_delay -clock [get_clocks {clk}] -max 2.000 [get_ports {rst up down load}]
set_input_delay -clock [get_clocks {clk}] -min 0.500 [get_ports {rst up down load}]
...
set_input_transition 0.150 [get_ports {rst up down load}]
